...
builder.Services.AddScoped<Membera.Auth.Application.Auth.SendEmailVerificationOtp.SendEmailVerificationOtpHandler>();
builder.Services.AddScoped<Membera.Auth.Application.Auth.VerifyEmail.VerifyEmailHandler>();
builder.Services.AddScoped<Membera.Auth.Application.Auth.ForgotPassword.ForgotPasswordHandler>();
builder.Services.AddScoped<Membera.Auth.Application.Auth.ResetPassword.ResetPasswordHandler>();
